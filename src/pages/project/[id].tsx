    ...
    <S.ProjectContainer>
      <S.Banner>
        ...
        <div className="bannerContainer">
          ...
          <div className="link" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1rem' }}>
            ...
            <Link href={`${project.github}#readme`} target="_blank">
              <ButtonAlt>
                View README <FaAddressBook size={15} />
              </ButtonAlt>
            </Link>
          </div>
        </div>
