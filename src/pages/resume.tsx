...
export default function Resume() {
  ...
  return (
    <>
      <Head>
        <title>{currentLang === 'ta' ? 'சுயவிவரம் | கிர்தன்குமார்' : 'Resume | Kirtankumar'}</title>
        <meta
          name="description"
        ...
        />
        <meta property="og:title" content={currentLang === 'ta' ? 'சுயவிவரம் | கிர்தன்குமார்' : 'Resume | Kirtankumar'} />
        <meta
      ...
      <Section>
        ...
        <PageSection>
          <iframe
            src="/pdf/Kirtankumar_Panchal_CV (3).pdf"
            title="Kirtankumar Resume"
          />
