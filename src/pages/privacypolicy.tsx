        ...
        <FadeInAnimation delay={0.4}>
          ...
          <div>
            ...
            <ul>
              ...
              <li><strong>Cal.com:</strong> {currentLang === 'ta' ? 'சந்திப்புகள் மற்றும் கூட்டங்களை திட்டமிடுகிறது மற்றும் நிர்வகிக்கிறது.' : 'Schedules and manages appointments and meetings.'}</li>
