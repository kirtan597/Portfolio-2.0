        ...
        <CVContent>
          <CVDescription>
            ...
            <div className="profile">
              <img src="/mirror image.jpg" alt="Profile Image" />
              <div className="name">
                <h3>Panchal Kirtankumar</h3>
                <span>{currentLang === 'ta' ? 'மென்பொருள் உருவாக்குநர் | AI-வலை ஆர்வலர்' : 'Software Developer | AI-Web Enthusiast'}</span>
              </div>
            </div>
          </CVDescription>
          ...
          <Curriculum>
            ...
            <a href="/pdf/Kirtankumar_Panchal_CV (3).pdf" download>
              <ButtonSecondAlt>
